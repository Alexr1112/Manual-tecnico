        ...
        <section className={styles.features}>
          ...
          <div className={styles.cardContainer}>
            <div className={styles.featureCard}>
              <FaUserInjured size={50} color="#4caf50" /> {/* Icono para Pacientes */}
            ...
            <div className={styles.featureCard}>
              <FaUserMd size={50} color="#4caf50" /> {/* Icono para Médicos */}
            ...
            <div className={styles.featureCard}>
              <FaCogs size={50} color="#4caf50" /> {/* Icono para Administración */}
